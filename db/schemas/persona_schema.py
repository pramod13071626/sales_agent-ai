...
class PersonaSchema(BaseModel):
    ...
    def from_enriched_json(cls, person: dict, tree_info: dict = None) -> "PersonaSchema":
        ...
        return cls(
            ...
            personalized_icebreaker=l3.get("personalized_icebreaker"),
            ...
            skills=[s for s in (l1.get("skills") or []) if s],
            target_kpis=[k for k in (l2.get("target_kpis") or []) if k],
            operational_pain_points=[p for p in (l2.get("operational_pain_points") or []) if p],
