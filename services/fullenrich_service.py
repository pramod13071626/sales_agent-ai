...
class FullEnrichService:
    ...
    def enrich_persona_record(
        ...
        return {
            ...
            "social_profile_url": soc_url if (soc_url and "linkedin.com" in soc_url and "/search/" not in soc_url) else None,
            "linkedin_url": soc_url if (soc_url and "linkedin.com" in soc_url and "/search/" not in soc_url) else None,
            "twitter_handle": None,
            ...
            "youtube_interviews_url": None,
            "podcast_search_url": None,
